<!--
  整页由 scripts/generate.py 渲染（.github/workflows/profile.yml 每天重跑）。
  改文案 → scripts/config.json；改样式 → scripts/generate.py。
-->
<div align="center">
...
<picture>
  ...
  <img src="https://raw.githubusercontent.com/RollandXD/RollandXD/output/snake-light.svg" width="100%" alt="贪吃蛇吃掉贡献图" />
</picture>

<sub>Catppuccin Mocha / Latte · Maple Mono · 由 GitHub Actions 每日重新渲染</sub>
